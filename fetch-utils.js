...
export async function createItem(grocerie) {
    const response = await client.from('groceries').insert({ description: grocerie, complete: false, user_id: client.auth.user().id });
